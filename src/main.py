...
def run(args):
    ...
    filename = "best_ckpt_{epoch}_{train_bleu:.4f}_{valid_bleu:.4f}"
    monitor = "valid_bleu"
...
if __name__=='__main__':
    ...
    assert args.model_name in ["bert", "todbert", "convbert"], "You must specify a supported model name."
    if "bert" in args.model_name:
